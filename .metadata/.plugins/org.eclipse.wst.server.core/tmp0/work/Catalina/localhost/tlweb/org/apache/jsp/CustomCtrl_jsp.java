 ...
 * Generated at: 2017-07-21 02:21:48 UTC
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String checkEq="";
 	try{
      ...
      out.write("\t\t\t\tplaceholder=\"请输入设备SN码  例:MF16040600A\" type=\"text\" maxlength=20 onblur=\"checkSN(this)\">\r\n");
      ...
      out.write("\t\t\t\t\t<tr><td>1.使用前请仔细阅读本产品使用说明书 2.使用过程中严禁违规操作 3.请确保操作人员已明确知晓重要安全说明</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td><h4>保修事项</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td>1.对于违规操作产生的故障不予以保修 2.保修起始日期为注册日期 3.如注册日期与出厂日期相差15日按出厂日期计算保修日期 4.未在官网激活设备将不予以保修</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td><h4>其他事项</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td>1.收货前请与经销商确认出厂日期 2.保修详细：电机及泵保修365日； 3.电器、电气设备保修30日</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td><input  type=\"checkbox\" id=\"agreement\" onclick=\"checkUserAgree(this)\">已仔细阅读上述要求及事项,并同意遵守</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<input id=\"registerB\" style=\"position:absolute; border:0px;color:white;font-size:20px;border-radius:3px;\r\n");
      out.write("\t\t\twidth:300px;height:45px;background-color:gray;left:300px;bottom:30px;\" type=\"button\"  value=\"注册\" \r\n");
      out.write("\t\t\tonmousemove=\"getFocus()\" onclick=\"clickButton()\" disabled=true>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id=\"\">\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("var start=createRequest('AjaxJs/ReturnService.jsp?service='+encodeURI(\"产品注册\")+'&id='+");
      out.print(id);
      out.write("+'&datetime='+new Date().getTime());\r\n");
      ...
      out.write("\tcheckEq=false;\r\n");
      out.write("\tdocument.getElementById(\"sntip\").innerHTML=\"\";\r\n");
      out.write("\tdocument.getElementById(\"SN\").value=\"\";\r\n");
      out.write("\tdocument.getElementById(\"registerB\").value=\"注册\";\r\n");
      out.write("\tdocument.getElementById(\"agreement\").checked=false;\r\n");
      ...
      out.write("\t//alert(str);\r\n");
      out.write("\tcreateRequest(\"AjaxJs/ReturnService.jsp?service=\"+encodeURI(str)+\"&id=\"+");
      out.print(id);
      out.write("+\"&datetime=\"+new Date().getTime());\r\n");
      out.write("\t//alert(str);\r\n");
      out.write("}\r\n");
      out.write("var checkEq=false;\r\n");
      out.write("function checkUserAgree(obj){\r\n");
      out.write("\tif(checkEq){\r\n");
      ...
      out.write("        return false;\r\n");
      out.write("    }\r\n");
      out.write("    http_request.onreadystatechange = getCheckSNResult;\t\t\t\t\t   //调用返回结果处理函数\r\n");
      out.write("    http_request.open('GET', url, true);\t\t\t\t\t\t\t   //创建与服务器的连接\r\n");
      out.write("    http_request.send(null);\t\t\t\t\t\t\t\t\t   //向服务器发送请求\r\n");
      out.write("}\r\n");
      ...
      out.write("    if (http_request.readyState == 4) {     \t\t// 判断请求状态\r\n");
      out.write("        if (http_request.status == 200) {  // 请求成功，开始处理返回结果\r\n");
      out.write("        \tif(http_request.responseText==0){\r\n");
      out.write("        \t\tcheckEq=true;\r\n");
      out.write("        \t\tdocument.getElementById(\"sntip\").innerHTML=\"\";\r\n");
      out.write("        \t\tcheckUserAgree(document.getElementById(\"agreement\"));\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\t//checkEq=false;\r\n");
      out.write("        \t\tdocument.getElementById(\"sntip\").innerHTML=\"序列号已激活或不存在\";\r\n");
      out.write("        \t\tcheckUserAgree(document.getElementById(\"agreement\"));\r\n");
      out.write("        \t}\t\r\n");
      out.write("        \t//设置提示内容\r\n");
      out.write("            //alert(http_request.responseText);\r\n");
      ...
      out.write("\t\t\tcreateCheckSNRequest(\"AjaxJs/CheckSN.jsp?sn=\"+encodeURI(obj.value)+\"&datetime=\"+new Date().getTime());\r\n");
      out.write("\t\t}else{\r\n");
      ...
      out.write("\r\n");
      out.write("//-------------------------------------------------------------\r\n");
      out.write("function createRegisterRequest(url) {\r\n");
      out.write("\tcheckEq=false;\r\n");
      out.write("    http_request = false;\r\n");
      out.write("    if (window.XMLHttpRequest) {    \t\t\t\t\t\t\t   // 非IE浏览器\r\n");
      out.write("        http_request = new XMLHttpRequest();\t                      //创建XMLHttpRequest对象\r\n");
      ...
      out.write("        return false;\r\n");
      out.write("    }\r\n");
      out.write("    http_request.onreadystatechange = getRegisterResult;\t\t\t\t\t   //调用返回结果处理函数\r\n");
      out.write("    http_request.open('GET', url, true);\t\t\t\t\t\t\t   //创建与服务器的连接\r\n");
      out.write("    http_request.send(null);\t\t\t\t\t\t\t\t\t   //向服务器发送请求\r\n");
      out.write("}\r\n");
      out.write("function getRegisterResult() {\r\n");
      out.write("    if (http_request.readyState == 4) {     \t\t// 判断请求状态\r\n");
      out.write("        if (http_request.status == 200) {  // 请求成功，开始处理返回结果\r\n");
      out.write("        \tif(http_request.responseText==0){\r\n");
      out.write("        \t\tdocument.getElementById(\"sntip\").innerHTML=\"已注册成功\";\r\n");
      out.write("        \t\tdocument.getElementById(\"registerB\").value=\"已注册\";\r\n");
      out.write("        \t\tcreateRequest('AjaxJs/ReturnService.jsp?service='+encodeURI(\"产品注册\")+'&id='+");
      out.print(id);
      out.write("+'&datetime='+new Date().getTime());\r\n");
      out.write("        \t}else{\r\n");
      out.write("        \t\tdocument.getElementById(\"sntip\").innerHTML=\"未注册成功请重试\";\r\n");
      out.write("        \t\tdocument.getElementById(\"registerB\").disabled=false; \r\n");
      out.write("        \t\tdocument.getElementById(\"registerB\").style.backgroundColor=\"#5a98de\";\r\n");
      out.write("        \t\tdocument.getElementById(\"registerB\").value=\"注册\";\r\n");
      out.write("        \t}\t\r\n");
      ...
      out.write("\tvar tip=document.getElementById(\"sntip\").innerHTML; \r\n");
      out.write("\tvar val=document.getElementById(\"SN\").value;\r\n");
      out.write("\tvar uid=");
      out.print(id);
      out.write(";\r\n");
      out.write("\talert(uid);\r\n");
      out.write("\tif(tip==\"\"&&val!=\"\"){\r\n");
      out.write("\t\tif(checkEq){\r\n");
      out.write("\t\t\t//alert(\"收到Ajax返回值\");\r\n");
      out.write("\t\t\tdocument.getElementById(\"registerB\").disabled=true; \r\n");
      out.write("\t\t\tdocument.getElementById(\"registerB\").style.backgroundColor=\"gray\";\r\n");
      out.write("\t\t\tcreateRegisterRequest(\"AjaxJs/RegisterProduct.jsp?uid=\"+encodeURI(uid)+\"&sn=\"+encodeURI(val)+\"&datetime=\"+new Date().getTime());\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t//alert(\"未收到Ajax返回值\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\talert(\"请确保序列号符合要求\");\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("</html>");
